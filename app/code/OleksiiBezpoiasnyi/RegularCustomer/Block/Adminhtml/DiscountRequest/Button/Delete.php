...
namespace OleksiiBezpoiasnyi\RegularCustomer\Block\Adminhtml\DiscountRequest\Button;
...
class Delete implements \Magento\Framework\View\Element\UiComponent\Control\ButtonProviderInterface
{
    ...
    public function getButtonData(): array
    {
        ...
        $message = $this->escaper->escapeJs($this->escaper->escapeHtml(__('Are you sure you want to delete this request?')));
